/**
 * Asserts that the unified discriminator DROPS Case E commits — non-merges
 ...
 *
 * Run: npx tsx shadow-tests/test-discriminator-case-e.ts
 */
...
async function main() {
  ...
  try {
    ...
    console.log("\n  ✓ PASS — Case E commits dropped, idempotent, no trailer-only synthetics.");
  } finally {
    setBranchFiltersForTesting(null);
